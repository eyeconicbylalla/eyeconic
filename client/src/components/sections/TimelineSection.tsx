...
const TimelineSection: React.FC = () => {
	...
	return (
		<section id="about" ref={sectionRef} className="py-20 bg-[#101720]">
			<div className="container mx-auto px-4">
				...
				<div className="story-timeline relative mx-auto mt-16 max-w-5xl">
					<div
						className="absolute left-6 top-0 h-full w-1 rounded-full bg-white/10 shadow-[0_0_18px_rgba(20,184,166,0.15)] md:left-1/2 md:w-px"
						aria-hidden="true"
					>
						<div className="story-timeline-line-fill absolute inset-x-0 top-0 h-full origin-top rounded-full bg-gradient-to-b from-teal-400 via-[#18B6A4] to-teal-500 shadow-[0_0_24px_rgba(20,184,166,0.35)]" />
					</div>
					...
					{timelineItems.map((item, index) => (
						...
						>
							<div className="hidden md:block">
								{index % 2 === 0 ? (
									<article
										className="story-timeline-card rounded-2xl border border-white/[0.06] bg-[#18222E] p-6 text-right shadow-card-dark"
										data-side="left"
									>
							...
							<div className="story-timeline-marker absolute left-0 top-1 flex h-12 w-12 items-center justify-center rounded-full border-4 border-[#101720] bg-[#18222E] text-sm font-bold shadow-md md:static md:h-16 md:w-20 md:text-lg">
								<span>
									{item.year}
								</span>
							</div>
							<div>
								{index % 2 !== 0 ? (
									<article
										className="story-timeline-card rounded-2xl border border-white/[0.06] bg-[#18222E] p-6 text-left shadow-card-dark"
										data-side="right"
									>
										<p className="story-timeline-card__year mb-3 text-sm font-bold uppercase tracking-wide">
											{item.year}
									...
									<article
										className="story-timeline-card rounded-2xl border border-white/[0.06] bg-[#18222E] p-6 text-left shadow-card-dark md:hidden"
										data-side="right"
									>
										<p className="story-timeline-card__year mb-3 text-sm font-bold uppercase tracking-wide">
											{item.year}
				...
				<div className="mt-12 text-center">
					<span className="text-[#4DD7C8] text-xl italic font-semibold">
			...
			<section
				id="about-eyeconic"
				className="py-20 bg-[#0A0F14] border-b border-white/[0.06]"
			>
				<div className="container mx-auto px-4">
					<motion.h2
					...
					<motion.p
						className="text-lg md:text-xl text-[#CBD5E1] mb-8 text-center max-w-3xl mx-auto"
						initial={{ opacity: 0, y: 20 }}
						whileInView={{ opacity: 1, y: 0 }}
						viewport={{ once: true }}
						transition={{ duration: 0.6, delay: 0.2 }}
					...
					<div className="grid md:grid-cols-2 gap-8 items-start max-w-4xl mx-auto">
						<div className="mt-5">
							<h3 className="text-xl font-bold text-white mb-4 md:text-center">Our Mission</h3>
							<p className="text-[#94A3B8] mb-6 md:text-center leading-relaxed">
							...
							<h3 className="text-xl font-bold text-white mb-4 md:text-center">
								What Makes Eyeconic Truly ICONIC?
							</h3>
							<ul className="list-disc pl-5 space-y-2 text-[#CBD5E1]">
								<li>
									<span className="font-bold text-white">Personalized Mentorship:</span>{' '}
									Tailored guidance that adapts to your learning style, strengths,
									and areas needing attention.
								</li>
								<li>
									<span className="font-bold text-white">Strategic Preparation:</span>{' '}
									Step-by-step approach ensuring comprehensive coverage, smart
									revisions, and consistent improvement.
								</li>
								<li>
									<span className="font-bold text-white">Interactive Community:</span>{' '}
									A vibrant, engaging, and supportive peer group led by motivated
									mentors.
								</li>
								<li>
									<span className="font-bold text-white">Result-driven Approach:</span>{' '}
									Proven methodologies that focus on performance tracking,
									analysis, and continuous feedback.
								</li>
							</ul>
						</div>
						<div className="bg-[#18222E] rounded-2xl shadow-card-dark p-6 border border-white/[0.06] flex flex-col h-full">
							<h3 className="text-xl font-bold text-white mb-2 md:text-center">
								Meet Our Founder: Dr. Gourav Lalla
							</h3>
							<p className="text-[#94A3B8] mb-4 md:text-center leading-relaxed">
							...
							<p className="font-semibold text-[#CBD5E1] mb-6 md:text-center leading-relaxed">
